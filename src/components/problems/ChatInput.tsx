	...
	return (
		<>
			{isAuthenticated ? (
				...
				<div className="flex flex-col items-center justify-center h-[84px] border border-[#e0e0e0] rounded-lg p-4 text-center text-sm text-[#666] bg-gray-50">
					<span>채팅 기능을 이용하려면 로그인이 필요합니다.</span>
					<Link
						to="/login"
